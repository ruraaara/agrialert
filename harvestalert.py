...
div[data-baseweb="tab-list"] { background: #FFFFFF !important; border: 2px solid #669B49 !important;div[data-baseweb="tab-list"] { background: #FFFFFF !important; border: 2px solid #DF8107 !important; border-radius: var(--radius-md) !important; padding: 5px !important; gap: 4px !important; margin-bottom: 20px; box-shadow: 0 2px 8px rgba(102,155,73,0.10); display: flex !important; width: 100% !important; }
